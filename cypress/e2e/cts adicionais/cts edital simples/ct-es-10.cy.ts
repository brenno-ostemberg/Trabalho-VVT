...
describe('Sistema Integrado de Gestão - Validação Período de Submissão', () => {
  it.only('CT-ES-09 - Período de Submissão - Data Hora Inicial e Data Hora Final IGUAIS', () => {
...
// Relatorio de Erros:
// O CT-ES-10 apresenta um erro no sistema, ao inserir a data de início e fim iguais  
...
// Cobertura: é um cenário que utiliza um valor limite 